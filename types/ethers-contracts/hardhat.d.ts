...
getContractFactory(name: 'SupplyChain', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.SupplyChain__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'SupplyChain', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.SupplyChain>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'SupplyChain', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SupplyChain>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'SupplyChain', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SupplyChain>
